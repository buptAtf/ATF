        ...
        update(){
            $.ajax({
                ...
                data: JSON.stringify({
                        ...
                        submissionId:$('#detailForm select[name="missionId"]').val(),
                        ...
                        author:$('#detailForm select[name="author"]').val(),
                        reviewer:$('#detailForm select[name="reviewer"]').val(),
                        executor:$('#detailForm select[name="executor"]').val(),
